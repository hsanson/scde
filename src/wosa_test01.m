...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[S,f,a] = scd(sn_noisy,L/16,'WOSA',fs);
figure(2);
subplot(221);
contour(a,f,abs(S));
title('BPSK Cyclic Spectrum (WOSA N/16)','FontSize', 16);
...
[S,f,a] = scd(sn_noisy,L/8,'WOSA',fs);
figure(2);
subplot(222);
contour(a,f,abs(S));
title('BPSK Cyclic Spectrum (WOSA N/8)','FontSize', 16);
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
figure(5);
...
[S,f,a] = scd(sn_noisy,L/4,'WOSA',fs);
figure(2);
subplot(223);
contour(a,f,abs(S));
title('BPSK Cyclic Spectrum (WOSA N/4)','FontSize', 16);
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
figure(5);
...
[S,f,a] = scd(sn_noisy,L/2,'WOSA',fs);
figure(2);
subplot(224);
contour(a,f,abs(S));
title('BPSK Cyclic Spectrum (WOSA N/2)','FontSize', 16);
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
figure(5);
