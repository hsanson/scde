%
%   File:      powerspectra12.m
%   Author(s): Horacio Sanson
%   Revision : 2007/11/6

%   Description:
%        Obtain the variance and vias of APES PSD estimators for different SNR
%        and filter lengths.
%
%   Notes:
...
title('Variance of APES Estimator','FontSize',16,'FontWeight', 'bold');
...
set(fig1, 'LineWidth', 1.5, 'MarkerSize', 8.0);
legend('N/16 length', 'N/8 length', 'N/4 length', 'N/2 length');
title('Bias of APES Estimator','FontSize',16,'FontWeight', 'bold');
ylabel('Mean Square Error','FontSize',16,'FontWeight', 'bold');
xlabel('Signal to Noise Ratio (dB)','FontSize',16,'FontWeight', 'bold');
grid on;
set(gca, 'Box', 'off','TickDir', 'out', 'FontSize',16 ); % here gca means get current axis
...
set(fig1, 'LineWidth', 1.5, 'MarkerSize', 8.0);
legend('N/16 length', 'N/8 length', 'N/4 length', 'N/2 length');
title('Mean Squared Error of APES Estimator','FontSize',16,'FontWeight', 'bold');
ylabel('Mean Square Error','FontSize',16,'FontWeight', 'bold');
xlabel('Signal to Noise Ratio (dB)','FontSize',16,'FontWeight', 'bold');
grid on;
set(gca, 'Box', 'off','TickDir', 'out', 'FontSize',16 ); % here gca means get current axis
