%
%   File:      capon2_test02.m
%   Author(s): Horacio Sanson
%   Revision : 2007/11/6
%
%   Description:
%       Example of SCD estimation of Sinusoid signal using NMVDR for diferent filter sizes.
%   Notes:
%        - Tested with Matlab 2007a
%        - Careful with the NMVDR method that is cpu intensive.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[S,f,a] = scd(y,N/16,'NMVDR',fs);
figure(1);
subplot(221);
contour(a,f,abs(S));
title('Sinusoid Spectral Correlation (NMVDR N/16)','FontSize', 16);
...
[S,f,a] = scd(y,N/8,'NMVDR',fs);
figure(1);
subplot(222);
contour(a,f,abs(S));
title('Sinusoid Spectral Correlation (NMVDR N/8)','FontSize', 16);
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
figure(4);
...
[S,f,a] = scd(y,N/4,'NMVDR',fs);
figure(1);
subplot(223);
contour(a,f,abs(S));
title('Sinusoid Spectral Correlation (NMVDR N/4)','FontSize', 16);
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
figure(4);
...
[S,f,a] = scd(y,N/2,'NMVDR',fs);
figure(1);
subplot(224);
contour(a,f,abs(S));
title('Sinusoid Spectral Correlation (NMVDR N/2)','FontSize', 16);
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
figure(4);
