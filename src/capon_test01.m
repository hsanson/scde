...
%
%   Description:
%       Example of SCD estimation using MVDR for diferent filter sizes
%   Notes:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[S,f,a] = scd(sn_noisy,L/16,'MVDR',fs);
figure(1);
subplot(221);
contour(a,f,abs(S));
title('BPSK Spectral Correlation (MVDR N/16)','FontSize', 16);
...
[S,f,a] = scd(sn_noisy,L/8,'MVDR',fs);
figure(1);
subplot(222);
contour(a,f,abs(S));
...
[S,f,a] = scd(sn_noisy,L/4,'MVDR',fs);
figure(1);
subplot(223);
contour(a,f,abs(S));
title('BPSK Spectral Correlation (MVDR N/4)','FontSize', 16);
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
figure(4);
...
[S,f,a] = scd(sn_noisy,L/2,'MVDR',fs);
figure(1);
subplot(224);
contour(a,f,abs(S));
title('BPSK Spectral Correlation (MVDR N/2)','FontSize', 16);
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
figure(4);
