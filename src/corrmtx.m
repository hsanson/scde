...
%   Modified by: Horacio Sanson 	   
%   Modified at: 2007/10/17

%   Description: 
%       Mimicks the function corrmtx available in Matlab DSP toolbox
%
%   Notes: 
...
if nargin == 2
    ...
    methods_list = {'autocorrelation','covariance','modified','prewindowed','postwindowed'};
