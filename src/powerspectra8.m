...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[Sw,fw,aw] = scd(sn_noisy,N,'WOSA',fs);
[Sc,fc,ac] = scd(sn_noisy,N,'MVDR',fs);
%[S2,f2,a2] = scd(sn_noisy,N,'NMVDR',fs);
[Sa,fa,aa] = scd(sn_noisy,N,'APES',fs);
...
subplot(224);
contour(aa,fa,abs(Sa));
xlabel('\alpha','FontSize', 16);
ylabel('freq (Hz)','FontSize', 16);
zlabel('PSD','FontSize', 16);
title('BPSK Cyclic Spectrum (APES)','FontSize', 16);
